...
if __name__ == "__main__":
    ...
    # Data id (Задаю количество изображений руками = 76)
    cur_id = 0
    while (cur_id <= 76):
        # Loading the image
        ...
        image_name = str(cur_id) + ".png"
        plt.imsave(image_name, out)

        os.replace('C:/Users/Hp/Desktop/DenseMap/' + image_name, 'C:/Users/Hp/Desktop/monodepth2/assets/lidar/' + image_name)
        cur_id += 1
